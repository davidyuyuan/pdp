...
cp -f "${run_dump}" "${output_dir}/run_dump.csv.gz" && \
  ...
  "run_accession:STRING,study_accession:STRING,submitted_bytes:NUMERIC,scientific_name:STRING,last_updated:DATE,submitted_format:STRING,submitted_md5:STRING,submitted_path:STRING,data_file_role:STRING,submission_account_id:STRING,tax_id:STRING,run_first_created:DATE,fire_oid:STRING"
